        ...
        private function getTableColArray() {
            ...
            switch ($this->dbName) {
                ...
                case "NL_HOUSES":
                    ...
                    break;
                case "NL_PROP_RESALE":
                    $colNames = ["NL_PROP_RESALE_AREA_FULL", "NL_PROP_RESALE_ADDRESS", "NL_PROP_RESALE_FLOOR", "NL_PROP_RESALE_COST_TOTAL", "NL_PROP_RESALE_PHONE_OWNER", "ID_NL_VIEW", "ID_NL_MATERIAL", "ID_NL_HOUSES", "ID_NL_USER", "NL_PROP_RESALE_PHONE", "NL_PROP_RESALE_PHOTO_URLS", "NL_PROP_RESALE_DESCRIPTION"];
                    $table = $this->getTableColArrayByColumnNames($tableName, $colNames);
                    break;
            }
        ...
        private function getTableLeftJoins() {
            switch ($this->dbName) {
                case "NL_USER":
                    ...
                    break;
                case "NL_PROP_RESALE":
                    return ["NL_VIEW", "NL_USER", "NL_MATERIAL", "NL_HOUSES"];
                    break;
                default:
                    return [];
                    break;
